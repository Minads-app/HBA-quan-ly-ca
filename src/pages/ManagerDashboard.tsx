              ...
              <table className="w-full border-collapse md:table-fixed">
                <thead className="sticky top-0 z-40 shadow-sm relative">
                  <tr className="bg-gray-100">
                    <th className="p-4 text-center text-sm font-bold text-gray-500 border-b border-gray-200 sticky left-0 top-0 bg-gray-100 z-50 w-20 md:w-[90px] shadow-[2px_0_5px_rgba(0,0,0,0.02)] align-middle border-r">
                      Ca Làm Việc
                    </th>
                    {daysLabels.map((day) => (
                      <th key={day.dateStr} className={`p-4 text-center border-b border-r border-gray-200 min-w-[120px] md:min-w-0 md:w-[13%] sticky top-0 bg-gray-50 z-30 align-middle ${day.isToday ? 'bg-blue-50/90' : ''}`}>
